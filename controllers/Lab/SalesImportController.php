...
class SalesImportController extends InitController
{
    private $importObj;
    ...
    public function beforeExecuteRoute(){
        ...
        if($this->importObj == null && $currentAction !== 'index'){
            ...
            $this->view->disable();
            $this->response->redirect("lab/sales_import/");
            return false;
        }
    }
    ...
    public function indexAction(){
        ...
        if ($this->request->isPost()){
            ...
            if(!count($errors)){
                ...
                $this->session->set('message', $message);
                return $this->response->redirect("lab/sales_import/");
            }
            ...
            return $this->response->redirect("lab/sales_import/map");
        }
    ...
    public function mapAction(){
        ...
        if ($this->request->isPost()){
            ...
            if($invalid){
                ...
                $this->session->set('message', $message);
                $this->view->disable();
                $this->response->redirect("lab/sales_import/map");
                return false;
            }
            ...
            return $this->response->redirect("lab/sales_import/overview");
        }
    ...
    public function overviewAction(){
        ...
        if ($this->request->isPost()){
            ...
            $this->view->disable();
            $this->response->redirect("lab/sales_import/confirm");
            return false;
        }
    ...
    public function confirmAction(){
        ...
        if ($this->request->isPost()){
            ...
            $this->view->disable();
            $this->response->redirect("lab/sales_import/complete");
            return false;
        }
    ...
    /*
     * ToDo Create email receiver and content
     */

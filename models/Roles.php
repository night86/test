...
class Roles extends Model
{
    ...
    {
        $this->hasMany('id', 'Signa\Models\UserRoles', 'role_id', array('alias' => 'UserRoles'));
        $this->hasMany('id', 'Signa\Models\RoleTemplatesRoles', 'role_id');
    }
    ...
    {
        // Doesn't work for console action in cli createRolesFromSecurityAction()
//        $user = $this->getDI()->getSession()->get('auth');

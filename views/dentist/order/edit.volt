                    ...
                    <table id="recipes" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        {% for recipeOrder in order.DentistOrderRecipe %}
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url("dentist/order/editproduct/" ~ recipeOrder.id) }}" class="btn-primary btn "><i
                                                class="pe-7s-pen"></i> {{ "Edit recipe"|t }}</a>
                                    <a data-order="{{ order.code }}" data-recipe="{{ recipeOrder.id }}" class="btn-danger btn deleteRecipe"><i
                                                class="pe-7s-close-circle"></i> {{ "Delete recipe"|t }}</a>
                                </td>
                            </tr>
                            {% endif %}
                        {% endfor %}
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group col-md-6" style="padding-left: 0;">
                        ...
                        <input id="patient_initials" name="data[patient_initials]" class="form-control" value="{{ order.DentistOrderData.patient_initials }}" required="required" />
                    </div>
                    <div class="form-group col-md-6" style="padding-right: 0;">
                        <label>{{ 'Patient insertion'|t }}</label>
                        <input id="patient_insertion" name="data[patient_insertion]" class="form-control" value="{{ order.DentistOrderData.patient_insertion }}" />
                    </div>
                    <div class="form-group">
                        <label>{{ 'Patient last name'|t }}</label>
                        <input id="patient_lastname" name="data[patient_lastname]" class="form-control" value="{{ order.DentistOrderData.patient_lastname }}" required="required" />
                    </div>
                    <div class="form-group">
                        <label>{{ 'BSN'|t }}</label>
                        <input id="bsn" name="bsn" class="form-control" type="text" value="{% if order.DentistOrderBsn and order.DentistOrderBsn.getBsn() is not null %}{{ order.DentistOrderBsn.getBsn() }}{% endif %}" />
                        <p>BSN alleen invullen indien voor uw administratie strikt noodzakelijk</p>
                    </div>
                    <div class="form-group">
                        <label>{{ 'Patient number'|t }}</label>
                        <input id="patient_number" name="data[patient_number]" class="form-control" type="text" value="{{ order.DentistOrderData.patient_number }}" />
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group col-md-4">
                        <label>{{ 'Date of birth'|t }}</label>
                        <select id="patient_birth_day" name="data[patient_birth][day]" class="form-control" required="required">
                    ...
                    <div class="form-group col-md-4">
                        <label>&nbsp;</label>
                        <select id="patient_birth_month" name="data[patient_birth][month]" class="form-control" required="required">
                    ...
                    <div class="form-group col-md-4">
                        <label>&nbsp;</label>
                        <select id="patient_birth_year" name="data[patient_birth][year]" class="form-control" required="required">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <br/><input {% if order.DentistOrderData.patient_gender is 'm' %}checked="checked"{% endif %}
                                    type="radio" name="data[patient_gender]" value="m"/> {{ "Male"|t }}
                        <br/><input {% if order.DentistOrderData.patient_gender is 'f' %}checked="checked"{% endif %}
                                    type="radio" name="data[patient_gender]" value="f"/> {{ "Female"|t }}
                    </div>
                </div>
                <div class="col-md-4">
                    {% if subDentists is not null %}
                        <div class="form-group">
                            ...
                            <select id="sub_dentist" name="dentist_user_id" class="form-control">
                                <option></option>
                    ...
                    <div class="form-group">
                        ...
                        <select id="locations" name="location_id" class="form-control" required="required">
                            <option></option>
                    ...
                    <div class="form-group">
                        <textarea id="description" name="description" placeholder="{{ 'Order notes or remarks...'|t }}" class="form-control"></textarea>
                    </div>
                </div>
            </div>

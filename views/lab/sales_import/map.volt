...
{% block content %}
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6" style="margin-bottom: 20px;">
            {{ select('map[]', allMaps, 'using': ['id', 'file'], 'useEmpty': true, 'emptyText': "Select culumns map"|t , 'emptyValue': 0, 'class': 'form-control', 'data-url':url('lab/sales_import/ajaxmap/'), 'id':'columns-maps') }}
        </div>
    </div>
    <div class="import-steps">
        ...
        <div class="row">
            <div class="col-md-12">
                {{ form('lab/sales_import/map', 'method': 'post') }}
                <fieldset class="form-group">
                    ...
                    <div class="col-lg-12">
                        <a href="{{ url('lab/sales_import/') }}" class="btn btn-primary pull-left"><i class="pe-7s-angle-left"></i> {{ "Previous step"|t }}</a>

<div class="container">
    ...
    <div class="row personal-data">
        <div class="col-xs-12">
            <span>{{ "Date"|t }}: <strong>{{ date("Y-m-d", strtotime(invoice.date)) }}</strong></span>
        </div>
        <div class="col-xs-12">
            <span>{{ "Order no."|t }}: <strong>{{ order.code }}</strong></span>
        </div>
        <div class="col-xs-12">
            <span>{{ "Invoice number"|t }}: <strong>{{ invoiceNumber }}</strong></span>
        </div>
    ...
    <div class="row personal-data">
        {% for dor in order.DentistOrderRecipe %}
            ...
            <div class="col-xs-12">
                ...
                <h4 class="pull-right">{{"Payment arrangement"|t}}: {{ paymentArrangement[dor.getId()] }}</h4>
            </div>
            <div class="col-xs-12">
        ...
        {% endfor %}
            ...
            <div class="col-xs-12">{{ lab.financial_data }}</div>
            <div class="col-xs-12">{{ lab.salutation }}</div>
            <div class="col-xs-12">{{ lab.invoice_footer }}</div>
    </div>
</div>

        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <tr>
                            ...
                            {% if row['status']|length %}
                                <td>{{ "ERROR"|t }} <span data-container="body" class="import-error" data-placement="left" data-trigger="hover"
                                                ...
                                                data-content="{{ row['status']|t }}"> <i class="fa fa-info-circle" aria-hidden="true"></i></span></td>
                            {% else %}
                                <td>{{ "OK"|t }}</td>
                            {% endif %}
                        </tr>
                ...
                <div class="col-lg-12" style="margin-bottom: 20px;">
                    <a href="{{ url('signadens/importcode/map') }}" class="btn btn-primary pull-left"><i class="pe-7s-angle-left"></i> {{ "Previous step"|t }}</a>
                    <a href="{{ url('signadens/importcode/confirm') }}" class="btn btn-primary pull-right">{{ "Next step"|t }} <i class="pe-7s-angle-right"></i></a>
                </div>
            </div>
        </div>
    </div>

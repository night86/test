...
{% block title %} {{ 'Tree categories'|t }} {% endblock %}
{% block content %}
    ...
    <p class="pull-right"><a href="#" id="addNewStep" class="btn btn-primary pull-right"> <i
                    class="pe-7s-plus"></i> {{ "New step"|t }}</a></p>
    <h3>{{ "Decision tree managment"|t }}</h3>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        <input type="text" placeholder="{{ "New step"|t }}" class="form-control" name="name">
                    </form>
                </div>
                            ...
                            <div class="col-md-12">
                                <select class="form-control select2-input new-product" name="product">
                                    {% for product in products %}
                                        <option value="{{ product.id }}">{{ product.recipe_number }} - {{ product.name }}</option>
                                    {% endfor %}
                                </select>
                            </div>
